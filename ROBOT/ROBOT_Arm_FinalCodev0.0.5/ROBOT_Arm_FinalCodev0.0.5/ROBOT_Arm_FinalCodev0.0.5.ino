...
#define PICK_ANGLE_MID 160
#define PICK_ANGLE_UPDOWN 35
...
#define SUCTION_OFF_DELAY 250
#define SUCTION_ON_DELAY 250
...
void vDefaultMotor1() {
  ...
  while (true) {
    ...
    if (y == 0) {
      ...
      for (int i = loop1; i > DEF_ANGLE_UPDOWN; i--) {
    ...
    if (y == 1 && tiStand_pos < giMax_pack) {
      digitalWrite(dirPin, LOW);
      for (int i = loop2; i < 12; i++) {
